...
| <a name="input_csoc_log_forwarding"></a> [csoc\_log\_forwarding](#input\_csoc\_log\_forwarding) | Whether to forward logs to the CSOC account (requires additional setup in the CSOC account to create subscription filters and permissions for the logs to be forwarded) | `bool` | `true` | no |
